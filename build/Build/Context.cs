...
namespace Build
{
    public class Context : FrostingContext
    {
        ...
        public IList<Lib> Lib { get; } = new List<Lib>() {
            new Lib() { BuildConfig = "Release", MainProject = @"src\Commons\Commons.csproj" }
        };
    ...
    public class General
    {
        ...
        public string Name { get; } = "Commons";

        public string SolutionName { get; } = "queo-csharp-commons.sln";
    }
    ...
    public class Tests
    {
        public Dictionary<string, string> TestProjects { get; } = new Dictionary<string, string>() {
            { "Commons.Tests", @"tests\Commons.Tests\Commons.Tests.csproj" }
        };
